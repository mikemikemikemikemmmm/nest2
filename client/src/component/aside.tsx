...
export const Aside = () => {
    ...
    return (
        <aside className=" align-top inline-block list-none text-aside" style={{ width: ASIDE_WIDTH }}>
            <ul>
                {
                    targetNavData.children.filter(category => category.children.length > 0).map(category => <ul key={category.id}>
                        <li>
